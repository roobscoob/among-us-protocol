...
| `byte` | Sync | This value is incremented every time this packet is sent, to keep players in sync. Eg, if a player entered and exited a scanner quickly, UDP may reorder the packets such that another player views the player "exiting" then entering a scanner, desyncing the player |
