...
1. [The Structure of the `GameOptionsData` Object](01_the_structure_of_the_gameoptionsdata_object.md)
1. [Converting Game IDs to and from Game Codes](02_converting_game_ids_to_and_from_game_codes.md)
1. [Reading the Client Version](03_reading_the_client_version.md)
1. [Map-Specific IDs for Vents and Tasks](04_map_specific_ids_for_vents_and_tasks.md)
